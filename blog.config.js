...
const BLOG = {
  AUTHOR: 'Caramel', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://one-piece.eu.org', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'a5eff4260024402aa897739ca772eaa5', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'C8LSG2D5H5', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'My BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'A Simple Blog', // 站点描述，被notion中的页面描述覆盖
